-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\project_detect\Compute_Power.vhd
...
BEGIN
  ...
  Product_out1 <= Data_Type_Conversion1_out1_re * Data_Type_Conversion1_out1_re;

  Product1_out1 <= Data_Type_Conversion1_out1_im * Data_Type_Conversion1_out1_im;

  Add_add_cast <= resize(Product_out1, 37);
  Add_add_cast_1 <= resize(Product1_out1, 37);
